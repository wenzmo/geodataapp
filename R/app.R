...
server <- function(input, output, session) {
  ...
  observeEvent(input$mainfolder, {
    subfolders <- sub_folders[[input$mainfolder]] # Access subfolder list by mainfolder name
  ...
  full_path <- shiny::reactive({
    ...
    file.path(paste(geopath, "GeoData", "data", sep = "/"), paste(input$mainfolder,input$subfolder,
                                      sep = "/"))
  })
